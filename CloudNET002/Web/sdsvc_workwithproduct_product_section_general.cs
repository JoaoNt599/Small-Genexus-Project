...
namespace GeneXus.Programs {
   public class sdsvc_workwithproduct_product_section_general : GXProcedure
   {
      public sdsvc_workwithproduct_product_section_general( )
      {
      ...
      public sdsvc_workwithproduct_product_section_general( IGxContext context )
      {
      ...
      protected void S111( )
      {
         /* AfterAttProductTypeCode Routine */
         returnInSub = false;
      ...
      public GxUnknownObjectCollection AfterAttProductTypeCode( short A5ProductTypeCode )
      {
         initialize();
         AV1Pmpt_producttypecode = A5ProductTypeCode;
         /* Execute user subroutine: AfterAttProductTypeCode */
         S111 ();
         ...
         /* End function AfterAttProductTypeCode */
         return gxjsonarray ;
      }
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.sdsvc_workwithproduct_product_section_general__default(),
            new Object[][] {
                new Object[] {
   ...
   public class sdsvc_workwithproduct_product_section_general__default : DataStoreHelperBase, IDataStoreHelper
   {
