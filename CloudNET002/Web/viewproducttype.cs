...
namespace GeneXus.Programs {
   public class viewproducttype : GXDataArea
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12ProductTypeCode = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
      ...
      protected void WB060( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Product Types", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewProductType.htm");
            ...
            GxWebStd.gx_label_element( context, edtProductTypeName_Internalname, "Type Name", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtProductTypeName_Internalname, StringUtil.RTrim( A6ProductTypeName), StringUtil.RTrim( context.localUtil.Format( A6ProductTypeName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProductTypeName_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtProductTypeName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_ViewProductType.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF062( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A5ProductTypeCode = H00062_A5ProductTypeCode[0];
               A6ProductTypeName = H00062_A6ProductTypeName[0];
      ...
      protected void STRUP060( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12ProductTypeCode = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vPRODUCTTYPECODE"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E11062( )
      {
         ...
         {
            A5ProductTypeCode = H00063_A5ProductTypeCode[0];
            A6ProductTypeName = H00063_A6ProductTypeName[0];
            AssignAttri("", false, "A6ProductTypeName", A6ProductTypeName);
            AV16GXLvl7 = 1;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(short)AV12ProductTypeCode});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Product") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Productwc_Component) != 0 )
            {
               ...
               WebComp_Productwc.componentprepare(new Object[] {(string)"W0034",(string)"",(short)AV12ProductTypeCode});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202362719394694", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewproducttype.js", "?202362719394694", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H00062_A5ProductTypeCode = new short[1] ;
         H00062_A6ProductTypeName = new string[] {""} ;
         hsh = "";
         H00063_A5ProductTypeCode = new short[1] ;
         H00063_A6ProductTypeName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewproducttype__default(),
            new Object[][] {
                new Object[] {
               H00062_A5ProductTypeCode, H00062_A6ProductTypeName
               }
               , new Object[] {
               H00063_A5ProductTypeCode, H00063_A6ProductTypeName
               }
            }
         );
      ...
      private short[] H00062_A5ProductTypeCode ;
      private string[] H00062_A6ProductTypeName ;
      private short[] H00063_A5ProductTypeCode ;
      private string[] H00063_A6ProductTypeName ;
   ...
   public class viewproducttype__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00062", "SELECT [ProductTypeCode], [ProductTypeName] FROM [ProductType] WHERE [ProductTypeCode] = @AV12ProductTypeCode ORDER BY [ProductTypeCode] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00062,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00063", "SELECT [ProductTypeCode], [ProductTypeName] FROM [ProductType] WHERE [ProductTypeCode] = @AV12ProductTypeCode ORDER BY [ProductTypeCode] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00063,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
