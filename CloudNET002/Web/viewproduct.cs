   ...
   public class viewproduct : GXDataArea
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12ProductCode = (long)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12ProductCode", StringUtil.LTrimStr( (decimal)(AV12ProductCode), 10, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vPRODUCTCODE", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ProductCode), "ZZZZZZZZZ9"), context));
      ...
      {
         GxWebStd.gx_hidden_field( context, "vPRODUCTCODE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12ProductCode), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPRODUCTCODE", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ProductCode), "ZZZZZZZZZ9"), context));
      ...
      {
         return formatLink("viewproduct.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12ProductCode,10,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"ProductCode","TabCode"})  ;
      }
      ...
      protected void WB0A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtProductName_Internalname, StringUtil.RTrim( A2ProductName), StringUtil.RTrim( context.localUtil.Format( A2ProductName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProductName_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtProductName_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_ViewProduct.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF0A2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1ProductCode = H000A2_A1ProductCode[0];
               A2ProductName = H000A2_A2ProductName[0];
      ...
      protected void STRUP0A0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12ProductCode = (long)(Math.Round(context.localUtil.CToN( cgiGet( "vPRODUCTCODE"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E110A2( )
      {
         ...
         {
            A1ProductCode = H000A3_A1ProductCode[0];
            A2ProductName = H000A3_A2ProductName[0];
            AssignAttri("", false, "A2ProductName", A2ProductName);
            AV16GXLvl7 = 1;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(long)AV12ProductCode});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12ProductCode = Convert.ToInt64(getParm(obj,0));
         AssignAttri("", false, "AV12ProductCode", StringUtil.LTrimStr( (decimal)(AV12ProductCode), 10, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vPRODUCTCODE", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ProductCode), "ZZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202362719464930", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewproduct.js", "?202362719464930", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12ProductCode',fld:'vPRODUCTCODE',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A2ProductName',fld:'PRODUCTNAME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000A2_A1ProductCode = new long[1] ;
         H000A2_A2ProductName = new string[] {""} ;
         hsh = "";
         H000A3_A1ProductCode = new long[1] ;
         H000A3_A2ProductName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewproduct__default(),
            new Object[][] {
                new Object[] {
               H000A2_A1ProductCode, H000A2_A2ProductName
               }
               , new Object[] {
               H000A3_A1ProductCode, H000A3_A2ProductName
               }
            }
         );
      ...
      private int idxLst ;
      private long AV12ProductCode ;
      private long wcpOAV12ProductCode ;
      ...
      private long[] H000A2_A1ProductCode ;
      private string[] H000A2_A2ProductName ;
      private long[] H000A3_A1ProductCode ;
      private string[] H000A3_A2ProductName ;
   ...
   public class viewproduct__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12ProductCode",GXType.Decimal,10,0)
          };
          Object[] prmH000A3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000A2", "SELECT [ProductCode], [ProductName] FROM [Product] WHERE [ProductCode] = @AV12ProductCode ORDER BY [ProductCode] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000A2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000A3", "SELECT [ProductCode], [ProductName] FROM [Product] WHERE [ProductCode] = @AV12ProductCode ORDER BY [ProductCode] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000A3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
