   ...
   public class notauthorized : GXDataArea
   {
      ...
      protected void WB050( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_3_052( true) ;
         }
         else
         {
            wb_table1_3_052( false) ;
         }
         return  ;
      }

      protected void wb_table1_3_052e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table2_12_052( true) ;
         }
         else
         {
            wb_table2_12_052( false) ;
         }
         return  ;
      }

      protected void wb_table2_12_052e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_15_052( true) ;
         }
         else
         {
            wb_table3_15_052( false) ;
         }
         return  ;
      }

      protected void wb_table3_15_052e( bool wbgen )
      {
         if ( wbgen )
         {
         }
      ...
      protected void wb_table3_15_052( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table3_15_052e( true) ;
         }
         else
         {
            wb_table3_15_052e( false) ;
         }
      }

      protected void wb_table2_12_052( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_12_052e( true) ;
         }
         else
         {
            wb_table2_12_052e( false) ;
         }
      }

      protected void wb_table1_3_052( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_3_052e( true) ;
         }
         else
         {
            wb_table1_3_052e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202362719394599", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("general/security/notauthorized.js", "?202362719394599", false, true);
