...
namespace GeneXus.Programs.general.ui {
   public class masterprompt : GXMasterPage
   {
      ...
      protected void RenderHtmlCloseForm022( )
      {
         ...
         context.AddJavascriptSource("general/ui/masterprompt.js", "?202362717202189", false, true);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?202362717202194", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("general/ui/masterprompt.js", "?202362717202194", false, true);
         }
