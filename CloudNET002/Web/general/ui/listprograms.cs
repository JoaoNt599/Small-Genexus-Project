...
namespace GeneXus.Programs.general.ui {
   public class listprograms : GXProcedure
   {
      ...
      {
         this.AV9ProgramNames = new GXBaseCollection<GeneXus.Programs.general.ui.SdtProgramNames_ProgramName>( context, "ProgramName", "Phamarcy") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBaseCollection<GeneXus.Programs.general.ui.SdtProgramNames_ProgramName> aP0_ProgramNames )
      {
         ...
         objlistprograms.AV9ProgramNames = new GXBaseCollection<GeneXus.Programs.general.ui.SdtProgramNames_ProgramName>( context, "ProgramName", "Phamarcy") ;
      ...
      void executePrivate( )
      {
         ...
         AV9ProgramNames = new GXBaseCollection<GeneXus.Programs.general.ui.SdtProgramNames_ProgramName>( context, "ProgramName", "Phamarcy");
         AV11name = "WWProduct";
