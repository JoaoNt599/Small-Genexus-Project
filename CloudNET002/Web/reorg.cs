...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      public reorg( )
      {
         ...
         IsMain = true;
         context.SetDefaultTheme("Phamarcy", false);
      }
      ...
      public void ReorganizeProduct( )
      {
         ...
         cmdBuffer=" ALTER TABLE [Product] ADD [ProductPhoto] VARBINARY(MAX) NOT NULL CONSTRAINT ProductPhotoProduct_DEFAULT DEFAULT CONVERT(varbinary(1), ''), [ProductPhoto_GXI] varchar(2048) NOT NULL CONSTRAINT ProductPhoto_GXIProduct_DEFAULT DEFAULT '' "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
         RGZ.Drop();
         cmdBuffer=" ALTER TABLE [Product] DROP CONSTRAINT ProductPhotoProduct_DEFAULT "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
         RGZ.Drop();
         cmdBuffer=" ALTER TABLE [Product] DROP CONSTRAINT ProductPhoto_GXIProduct_DEFAULT "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( ColumnExist("Product",sSchemaVar,"ProductPhoto") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"ProductPhoto", "Product"}) ) ;
            return false ;
         }
         if ( ColumnExist("Product",sSchemaVar,"ProductPhoto_GXI") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"ProductPhoto_GXI", "Product"}) ) ;
            return false ;
         }
         return true ;
      }
